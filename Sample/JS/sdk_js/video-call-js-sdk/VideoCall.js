...
(function () {
    ...
    const receivingCalling =
        ...
        `                   <span>Bạn có một cuộc gọi video call, Bạn có muốn nhận cuộc gọi ngay lúc này?</span>` +
        `               </div>` +
        ...
        VideoCall.prototype.initConnection = async function (
            ...
            try {
                ...
                stompClient.connect(
                    ...
                    function (frame) {
                        if (successCallback) {
                            successCallback(frame.command, stompClient);
                        }
                    },
                    (error) => {
                        if (
                            ...
                            if (successCallback) {
                                successCallback(DISCONNECTED, stompClient);
                            }
                            setTimeout(() => {
