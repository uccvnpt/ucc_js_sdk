...
(function () {
    ...
    VideoCall = (function () {
        ...
        function VideoCall(url, config, JitsiMeetExternalAPI) {
            this.config = config;
    ...
    VideoCallSDK = {
        initConfig: function (url, config, JitsiMeetExternalAPI) {
            video = new VideoCall(url, config, JitsiMeetExternalAPI);
            return video;
        },
    };
